...
class TestRepositoryVelocityFields:
    ...
    def test_star_history_json(self):
        history = [{'date': '2026-04-01', 'stars': 900}, {'date': '2026-04-04', 'stars': 1000}]
...
class TestComputeStarVelocity:
    ...
    def test_rising_star_classification(self):
        ...
        repo = make_repo(
            full_name='owner/rising', url='https://g.com/rising',
            stars=600, star_history=history,
        )
        self._run_task()
        repo.refresh_from_db()
    ...
    def test_stable_classification(self):
        ...
        repo = make_repo(
            full_name='owner/stable', url='https://g.com/stable',
            stars=1000, star_history=history,
        )
        self._run_task()
        repo.refresh_from_db()
    ...
    def test_declining_classification(self):
        ...
        repo = make_repo(
            full_name='owner/declining', url='https://g.com/declining',
            stars=1000, star_history=history,
        )
        self._run_task()
        repo.refresh_from_db()
    ...
    def test_velocity_7d_calculated_correctly(self):
        ...
        repo = make_repo(
            full_name='owner/vel', url='https://g.com/vel',
            stars=1000, star_history=history,
        )
        self._run_task()
        repo.refresh_from_db()
    ...
    def test_old_history_pruned_to_90_days(self):
        ...
        repo = make_repo(
            full_name='owner/prune', url='https://g.com/prune',
...
class TestGitHubTrendingView:
    ...
    def test_result_fields(self):
        ...
        if resp.data['data']:
            ...
            for field in ('full_name', 'url', 'stars', 'velocity_7d', 'trend_class', 'stars_7d_delta'):
                assert field in repo

    def test_filter_by_language(self):
        make_repo(full_name='o/py', url='https://g.com/py', language='Python', stars=500)
        make_repo(full_name='o/ts', url='https://g.com/ts', language='TypeScript', stars=400)
...
class TestGitHubEcosystemView:
    ...
    def test_returns_ecosystem_stats(self):
        ...
        make_repo(full_name='o/r2', url='https://g.com/r2', language='Rust', velocity_7d=30.0)
...
class TestGitHubRepoAnalysisView:
    ...
    def test_returns_full_analysis(self):
        ...
        assert resp.status_code == status.HTTP_200_OK
        data = resp.data['data']
        for field in ('id', 'full_name', 'velocity_7d', 'star_history', 'similar_repos'):
