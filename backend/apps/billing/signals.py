...
def create_user_subscription(sender, instance, created: bool, **kwargs) -> None:
    ...
    try:
        ...
        logger.error("subscription_creation_failed", user=instance.email, error=str(exc))
...
def create_user_referral_code(sender, instance, created: bool, **kwargs) -> None:
    ...
    try:
        ...
        logger.error("referral_code_creation_failed", user=instance.email, error=str(exc))
