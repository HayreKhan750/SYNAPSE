...
class TestAIGuardrails:
    ...
    def test_moderation_skips_without_api_key(self):
        ...
        import os
        with patch.dict(os.environ, {"MODERATION_ENABLED": "true", "OPENAI_API_KEY": ""}):
            import importlib, ai_engine.middleware.moderation as mod
            importlib.reload(mod)
    ...
    def test_budget_exceeded_error_has_correct_fields(self):
        ...
        try:
            ...
            exc = BudgetExceededError(used_cents=1000, limit_cents=500, reset_at="2026-04-06T00:00:00Z")
