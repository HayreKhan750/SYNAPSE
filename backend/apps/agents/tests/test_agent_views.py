...
class TestAgentToolRegistry:
    ...
    def test_registry_get_tools_all(self):
        ...
        tool_a = MagicMock(spec=StructuredTool); tool_a.name = "tool_a"
        tool_b = MagicMock(spec=StructuredTool); tool_b.name = "tool_b"
...
class TestSynapseAgentExecutor:
    ...
    def test_executor_health_tool_count(self):
        ...
        registry = AgentToolRegistry()
        registry._built = True
        t1 = MagicMock(); t1.name = "t1"; t1.description = "d1"
        t2 = MagicMock(); t2.name = "t2"; t2.description = "d2"
    ...
    def test_executor_run_delegates_to_agent(self):
        ...
        mock_agent.run.assert_called_once_with("What is the answer?", extra_context=None)
