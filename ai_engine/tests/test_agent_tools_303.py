...
class TestWebSearch:
    ...
    def test_returns_formatted_results(self):
        ...
        mock_client_instance.search.return_value = {
            'results': [
                {'title': 'AI News', 'url': 'https://example.com', 'content': 'AI is cool', 'score': 0.9},
            ]
        }
...
class TestRunPythonCode:
    ...
    def test_statistics_module_allowed(self):
        ...
        result = _run_python_code('import statistics\nprint(statistics.mean([1,2,3,4,5]))')
        assert result['success'] is True
...
class TestRegistryTask303:
    ...
    def test_new_tools_registered(self):
        ...
        for factory in [make_web_search_tool, make_run_python_tool,
                        make_read_document_tool, make_generate_chart_tool]:
            tool = factory()
