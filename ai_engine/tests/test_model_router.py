...
class TestResolveProviderModel:
    ...
    def test_explicit_anthropic_pro_user(self):
        ...
        from ai_engine.agents.router import resolve_provider_model, CLAUDE_PRIMARY
    ...
    def test_ollama_any_plan(self):
        ...
        from ai_engine.agents.router import resolve_provider_model, OLLAMA_DEFAULT
    ...
    def test_budget_fallback_switches_to_cheaper_model(self):
        ...
        from ai_engine.agents.router import resolve_provider_model, FALLBACK_MODELS
    ...
    def test_no_user_returns_primary(self):
        ...
        from ai_engine.agents.router import resolve_provider_model, PRIMARY_MODELS
    ...
    def test_anthropic_budget_fallback_to_haiku(self):
        ...
        from ai_engine.agents.router import resolve_provider_model, CLAUDE_FALLBACK
...
class TestSynapseAgentBuildLLM:
    ...
    def test_ollama_raises_without_package(self):
        ...
        with patch.object(base_mod, '_OLLAMA_AVAILABLE', False), \
